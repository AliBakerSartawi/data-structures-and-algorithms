...
const reversedString = (str) => {
  ...
  //// I tried to solve it alone but couldn't
  //// I found the solution online, but I only understood it after seeing the console logs
  //// The added string will be placed in the beginning, that's how it becomes reversed
};
